...
import com.tts.carwash.network.APIError;
import com.tts.carwash.network.ErrorUtils;
...
//        Toast.makeText(this, "Thanks " + sharedpreferences.getString("Name", null), Toast.LENGTH_LONG).show();
    ...
    public void next() {
        ...
        Call<Object> listCall2 = loginAPIHolder.getSignUpResponse(mobile.getText().toString(), generatedPIN);
